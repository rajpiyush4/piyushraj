    ...
    return (
        <section className='contact'>
            ...
            <div className='connect'>
                <div className='email'>
                    <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=piyushraj.me4@gmail.com" target="_blank" rel='noreferrer'>
                        Send an email
                    </a>
                </div>
            </div>
            ...
            <div className='socials-container'>
                ...
                <div className='socials'>
                    <ul>
                        ...
                        <li><span className='underline'><a href="/piyush_raj_25.pdf" download="piyush_raj_25.pdf" rel='noreferrer'>resume</a></span> ↗</li>
                    </ul>
                </div>
            </div>
        </section>
